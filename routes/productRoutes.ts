...
// Define the bindings (environment variables) that your worker expects
...
// Function to fetch location name from Nominatim API
...
// Function to generate a QR code as string with qrcode-terminal library
...
// Route for signing a batch of QR codes and generating a master QR code
  qrCodeRouter.post('/sign-batch', async (c) => {
    ...
    // Route for downloading a batch of QR codes as a ZIP file
    qrCodeRouter.get('/download-batch/:batchId', async (c) => {
